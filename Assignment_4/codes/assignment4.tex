...
\centering
\includegraphics[ width=\columnwidth , height =3cm]{2toss.PNG}
\caption{Simulation for tossing a fair coin twice }
\label{Fig:1}
\\
\includegraphics[ width=\columnwidth , height =3cm]{3toss.PNG}
\caption{Simulation for tossing a fair coin thrice }
\label{Fig:2}\\
\includegraphics[ width=\columnwidth , height =4cm]{4toss.PNG}
\caption{Simulation for tossing a fair coin 4 times }
\label{Fig:3}
\end{figure}
